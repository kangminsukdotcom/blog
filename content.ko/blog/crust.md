...
빵이란 게 뭔지 한 번이라도 진지하게 고민해 본 사람이라면, 정성 들여 구운 크러스트가 접시에 남겨진 걸 보면 답답할 수밖에 없다. 빵은 5,000년, 어쩌면 1만 년 가까이 이어져 온 발효 음식이다. 그런데 불과 100여 년 전부터, 상업용 이스트로 빠르게 부풀려 후다닥 구워내는 공장형 '포켓몬빵' 같은 빵이 등장했다.
